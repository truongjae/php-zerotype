...
<body>
	...
	<!-- <div id="contents"> -->
		<!-- <div id="tagline" class="clearfix"> -->
					<?php
						global $query;
						$posts = $query->getNewsById($_GET['id']);
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="author" class="form-control" name="name" value="<?php echo $post['author'] ?>">
                        </div>
                        <div class="mb-3">
                    ...
                    <?php
                     if(isset($_POST['submit'])){
                        global $query;
                        $run = $query->updatePostById($_GET['id'],$_POST['author'],$_POST['title'],$_POST['date'],$_POST['short_content'],$_POST['long_content']);
                        if($run)
