...
<body>
	...
	<!-- <div id="contents"> -->
		<!-- <div id="tagline" class="clearfix"> -->
					<center><h2 style="margin-top:15px;">Thêm thể loại bài viết</h2></center>
                    <div class="border-bottom my-3"></div>
                    <form method="POST" id="post">
                        <div class="mb-3">
                            <label class="form-label">Tên thể loại</label>
                            <textarea class="form-control" name="nameCategory" rows="2"></textarea>
                        </div>
                        <div class="mb-3">
                    ...
                    <?php
                     if(isset($_POST['submit'])){
                        global $query;
                        $run = $query->addCategory($_POST['nameCategory']);
                        if($run)
                            echo "<script>alert('Thêm thành công');window.location.href='/zerotype/category/category.php';</script>";
                     }
                    ?>
		<!-- </div> -->
	<!-- </div> -->
